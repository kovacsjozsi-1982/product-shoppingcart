...
export default function ProductCard({ product, onView, onEdit, onDelete, onAddToCart }) {
  return (
    <div
    ...
    >
      ...
      <div className="flex gap-[8px] mt-auto w-full">
        <button
          className="flex-1 flex items-center border border-[rgba(0,0,0,0.13)] rounded-[8px] py-[8px] text-[16px] font-medium text-[#18182A] bg-[#fff] hover:bg-[#F3F3F5] transition"
          onClick={onView}
        >
        ...
        <button
          className="flex-1 flex items-center border border-[#E3E6EA] rounded-[8px] py-[8px] text-[16px] font-medium text-[#18182A] bg-[#fff] hover:bg-[#F3F3F5] transition"
          onClick={onEdit}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '10px' }}>
        ...
        <button
          className="flex-1 flex items-center justify-center rounded-[8px] bg-[#D4183D] hover:bg-[#B31232] transition text-white py-[8px]"
          onClick={onDelete}
        >
        ...
        <button
          className="flex-1 flex items-center justify-center rounded-[8px] bg-[#1E90FF] hover:bg-[#1565C0] transition text-white py-[8px]"
          title="Add to cart"
          onClick={onAddToCart}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 6h15l-1.5 9h-13z" stroke="#fff" strokeWidth="2" fill="#1E90FF"/>
